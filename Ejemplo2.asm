...
; 1. Muestra una advertencia de no stack y es porque no se ha definido este segmeneto en el codigo 
; 2. Se imprime un *, y este resultado se da debido a que por el codigo ASCII no interpreta el numero de manera correcta 
; 3. Para que el resultado fuera una letra Z, fue necesario sumar 30 para que el numero si fuera tomado como el numero que es.  
